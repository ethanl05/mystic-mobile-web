  ...
  return (
    <div className="space-y-4">
      ...
      <section className="panel overflow-hidden p-3">
        <SectionHeader title="原始排盘" description="四柱原盘，可截图保存或分享。" action="四柱八字" />
        <ElementLegend />
        <BaziChartTable pillars={pillars} />
      </section>
      <section className="panel space-y-4 p-4">
        <SectionHeader title="结构摘要" description="从原始命盘中提取出的易读信息，适合快速理解整体结构。" />
      ...
      <section className="panel space-y-3 p-4">
        <SectionHeader title="AI 深度分析" description="AI 会基于上方原始命盘和结构摘要生成解释，不参与排盘计算。" />
  ...
  return (
    <section className="relative overflow-hidden rounded-lg border border-[#ddd2c0] bg-[#fffaf1] p-4 shadow-[0_18px_50px_rgba(75,48,27,0.08)]">
      ...
      <div className="relative flex items-center justify-between gap-4">
        <div>
          <p className="text-xs font-black uppercase tracking-[0.18em] text-[#8f2f24]">Bazi Report</p>
    ...
    <div className="mb-3">
      <div className="flex items-end justify-between gap-3">
        <div className="min-w-0">
          ...
          <p className="mt-1 text-xs leading-5 text-[#756a5d]">{description}</p>
        </div>
